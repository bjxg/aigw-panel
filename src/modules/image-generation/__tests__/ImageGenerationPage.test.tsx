...
const imageGenerationListChannelsMock = () =>
  imageGenerationApi.listChannels as unknown as ReturnType<typeof vi.fn>;
...
describe("ImageGenerationPage", () => {
  beforeEach(async () => {
    ...
    vi.spyOn(imageGenerationApi, "listChannels");
    vi.spyOn(imageGenerationApi, "startTestTask");
    vi.spyOn(imageGenerationApi, "getTestTask");
    imageGenerationListChannelsMock().mockResolvedValue({
      model: "gpt-image-2",
