      ...
      void updateApi
        ...
        .then((info) => {
          ...
          notify({
            ...
            classNames: {
              actionWrapper:
                "aigw-server-update-toast-action-wrapper flex justify-end overflow-visible",
              actionButton: buttonClassName({
                size: "xs",
                variant: "default",
                className:
                  "aigw-server-update-toast-action !inline-flex !w-auto !min-w-0 !self-end !rounded-full !px-2.5 !text-xs",
              }),
            },
          });
        })
